...
for t in $@; do
  ...
  if [ -e "${t}.sh" ] ; then
    ...
    . ${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /mnt/c/Users/steam/OneDrive/Desktop/rails/redis-5.0.4/deps/jemalloc/ /mnt/c/Users/steam/OneDrive/Desktop/rails/redis-5.0.4/deps/jemalloc/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /mnt/c/Users/steam/OneDrive/Desktop/rails/redis-5.0.4/deps/jemalloc/ /mnt/c/Users/steam/OneDrive/Desktop/rails/redis-5.0.4/deps/jemalloc/
